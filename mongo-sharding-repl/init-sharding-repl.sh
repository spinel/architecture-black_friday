...
wait_for_service "config2" "27017" || exit 1
wait_for_service "config3" "27017" || exit 1
wait_for_service "shard1_1" "27018" || exit 1
wait_for_service "shard1_2" "27018" || exit 1
wait_for_service "shard1_3" "27018" || exit 1
wait_for_service "shard2_1" "27019" || exit 1
wait_for_service "shard2_2" "27019" || exit 1
wait_for_service "shard2_3" "27019" || exit 1
